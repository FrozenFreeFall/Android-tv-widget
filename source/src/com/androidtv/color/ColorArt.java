...
/**
 * 获取图片的Primary,Secondary,DetailColor. 使用: <br>
 * 
 * Bitmap b = .. ... <br>
 * 如果是ImageView,则先使用imageView.buildDrawingCache(); <br>
 * 然后是 Bitmap b = imageView.getDrawingCache(); <br>
 * ColorArt colorArt = new ColorArt(b); <br>
 * 各种颜色获取: <br>
 * colorArt.getBackgroundColor | getPrimaryColor | getSecondaryColor | getDetailColor <br>
 * 
...
public class ColorArt {
	...
	/**
	 * 传入bitmap，找出Primary,Secondary,DetailColor 颜色.
	 */
